...
uint256 hashGenesisBlock("0x01b57e5a3cc09c9612f2abd303c5ba9f2f41690c770d896b25fbecdb8cae27bf");
...
const string strMessageMagic = "Digital-Dirham Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Digital-Dirham: 0.35 days
static const int64 nTargetSpacing = 15; // Digital-Dirham: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal digital-dirham miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Digital-Dirham", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe034cb82bb44410579bb0b5013c14d7cd657afcfa4cbaa34121916550f233469");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Thanks Giving Day 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1417180600;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388622752;

        if (fTestNet)
        {
            block.nTime    = 1417089271;
        ...
        assert(block.hashMerkleRoot == uint256("728cf404d0e83361f27021c05dfa5f3d9c7a71270c5abab3253260d68c61865b"));
